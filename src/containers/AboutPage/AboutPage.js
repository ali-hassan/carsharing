        ...
        <LayoutWrapperMain className={css.staticPageWrapper}>
          ...
          <div className={css.contentWrapper}>
            <div className={css.contentSide}>
              <p>Did you know that Finland has 3.2 million Cars - almost one sauna per person!</p>
            </div>

            <div className={css.contentMain}>
              <h2>
                Most of the Finnish Cars are located at the homes of individuals - indeed, most
              ...
              <p>
                To truly experience a Finnish sauna, you need to look beyond the public cars, and
                instead visit a real home or cottage sauna. Saunatime makes this possible for
                everyone. All our cars are owned by individuals willing to let tourists and other
